...
const commons = new CommonsChunk({
  ...
  chunks: ['{{cookiecutter.client_project_slug}}']
})
...
module.exports = {
  ...
  entry: {
    ...
    '{{cookiecutter.client_style_slug}}': path.resolve('./src/styles/main.js'),
    '{{cookiecutter.client_project_slug}}': path.resolve('./src/scripts/{{cookiecutter.client_project_slug}}/index.js')
  },
